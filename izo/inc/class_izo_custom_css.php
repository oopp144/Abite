...
if ( !class_exists( 'Izo_Custom_CSS' ) ) :
	...
	Class Izo_Custom_CSS {
		...
		public function output_css() {
			...
			$css .= $this->get_color_css( 'accent_color', '#ea285e', '.page.woocommerce-account .woocommerce-MyAccount-navigation ul li a:hover,.widget a:hover,.read-more:hover,.entry-meta a:hover,.entry-footer a:hover,article .entry-title a:hover,.comment-navigation a:hover,.posts-navigation a:hover,.post-navigation a:hover,.top-navigation ul a:hover,.main-navigation a:hover,.is-style-outline .wp-block-button__link,.wp-block-button__link.is-style-outline');
			 ...
			 * Buttons
			 */
			$css .= $this->get_background_color_css( 'global_button_background', '#ea285e', '.elementor-button-wrapper .elementor-button,button,.button,.wp-block-button__link,input[type="button"],input[type="reset"],input[type="submit"],.wpforms-form button[type=submit],div.wpforms-container-full .wpforms-form button[type=submit],div.nf-form-content input[type=button]');
			...
			$css .= $this->get_color_css( 'global_button_color', '#ffffff', '.elementor-button-wrapper .elementor-button,button,.button,.wp-block-button__link,input[type="button"],input[type="reset"],input[type="submit"],.wpforms-form button[type=submit],div.wpforms-container-full .wpforms-form button[type=submit],div.nf-form-content input[type=button]');
			$css .= $this->get_color_css( 'global_button_color_hover', '#ffffff', '.elementor-button-wrapper .elementor-button:hover,button:hover,.button:hover,.wp-block-button__link:hover,input[type="button"]:hover,input[type="reset"]:hover,input[type="submit"]:hover,.wpforms-form button[type=submit]:hover,div.wpforms-container-full .wpforms-form button[type=submit]:hover,div.nf-form-content input[type=button]:hover');
			...
			$css .= $this->get_color_css( 'main_header_button_color', '', '.menu-last-item .button');
			$css .= $this->get_color_css( 'main_header_button_color_hover', '', '.menu-last-item .button:hover');
			...
			$css .= $this->get_background_color_css( 'mobile_menu_background_color', '#fff', '#mobile-menu');
			$css .= $this->get_color_css( 'mobile_menu_items_color', '#1d1d1d', '#mobile-menu, #mobile-menu a');
			 ...
			 * Page layout
			 */
			$css .= '.layout-unboxed article { background: transparent;padding:0;} .layout-unboxed .widget-area .widget { background: transparent;padding:0;}' . "\n";	
		 ...
		 */
		public function get_background_color_css( $setting, $default, $selector ) {
			$mod = get_theme_mod( $setting, $default );
		 ...
		 */
		public function get_border_color_css( $setting, $default, $selector ) {
			$mod = get_theme_mod( $setting, $default );
		 ...
		 * Get fill color CSS
		 */
		public function get_fill_color_css( $setting, $default, $selector ) {
			$mod = get_theme_mod( $setting, $default );
