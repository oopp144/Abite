...
if ( !class_exists( 'Izo_Header' ) ) :
	...
	Class Izo_Header {
		...
		function main_navigation() {
			...
			?>
			<nav id="site-navigation" class="main-navigation" data-open="<?php echo esc_attr( $opening ); ?>">
			<button class="menu-toggle" aria-controls="primary-menu" aria-label="<?php echo esc_attr__( 'Toggle mobile menu', 'izo' ); ?>" aria-expanded="false"><?php izo_get_svg_icon( 'icon-bars', true ); ?><span class="menu-label"><?php echo esc_html( $mobile_label ); ?></span></button>
			<?php
			wp_nav_menu( array(
